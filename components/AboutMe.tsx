...
function Highlight({ href, children }: PropsWithChildren<{ href: string }>) {
  return <a className="highlight" target="_blank" href={href} onClick={e => e.stopPropagation()}>{children}</a>;
}
        ...
        <div>
          <div className="text-left font-sans">
            ...
            <p className="mt-4 text-xl">
              ...
              <Highlight href="https://www.vessel.dev/">
                Vessel
              </Highlight>
            ...
            <p className="mt-4 text-xl">
              ...
              will respond to most (relevant) emails. You can <Highlight href="mailto:zach@zkirby.com">contact</Highlight> me about anything, assuming it isn't an
