...
I recently had a thought: can an LM perform a set of abstract transformations that would map a body of text from any given linguistic domain (e.g., academic math papers) to any other (e.g., the sum total of everything I already know) without loss of meaning?
