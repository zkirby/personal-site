...
import Accordian from "@/components/writings/Accordian";

<Layout>

# Atomic Prompts: A systematic method for exploring .
...
<Accordian title="Writing Improvements">
  <ul>
    <li>
...
- Source paragraph
  To encourage divergent thinking and foster customization, educators can further generate variant scripts and utilize alternative prompts, expanding the possibilities for tailoring the output content to specific learning objectives.
...
- Translation
  To promote divergent thinking and customization, educators can create different scripts and use alternative prompts, broadening the potential to tailor content to specific learning objectives.
...
- Translation
  Imagine a spinning disk of primordial planetesimals, the building blocks of planets. The way this disk disperses influences the orbital evolution of the giant planets in our solar system.
